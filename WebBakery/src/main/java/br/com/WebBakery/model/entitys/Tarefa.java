...
public class Tarefa extends AbstractBaseModel {
    ...
    private static final String FK_FUNCIONARIO_TAREFA = Funcionario.FK_NAME + "_" + Tarefa.TABLE_NAME;
    ...
    @ManyToOne
    @JoinColumn(name = FK_FUNCIONARIO_TAREFA)
    private Funcionario padeiro;
    ...
    public Funcionario getPadeiro() {
        return padeiro;
    }

    public void setPadeiro(Funcionario padeiro) {
